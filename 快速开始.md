...
1、设置初始化函数: [init](API介绍/基本函数.md#init-初始化策略) , 使用 [schedule](API介绍/基本函数.md#schedule-定时任务配置) 函数进行定时任务配置
...
1、设置初始化函数: [init](API介绍/基本函数.md#init-初始化策略) , 使用 [subscribe](API介绍/数据订阅.md#subscribe-行情订阅) 函数进行数据订阅

2、实现一个函数: [on\_bar](API介绍/数据事件.md#on-bar-bar-数据推送事件) , 来根据数据推送进行逻辑处理, 通过 `context.data` 获取数据滑窗
...
1、设置初始化函数: [init](API介绍/基本函数.md#init-初始化策略) , 使用 [subscribe](API介绍/数据订阅.md#subscribe-行情订阅) 函数进行数据订阅代码

2、实现一个函数: [on\_bar](API介绍/数据事件.md#on-bar-bar-数据推送事件) , 来根据数据推送进行逻辑处理
...
1、设置初始化函数: [init](API介绍/基本函数.md#init-初始化策略) , 一次性拿到所有需要的 instruments 信息， 将信息按 symbol,date 作为 key 存入字典， 使用 [subscribe](API介绍/数据订阅.md#subscribe-行情订阅) 函数进行数据订阅代码
