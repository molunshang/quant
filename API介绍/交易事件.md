...
order | [order 对象](数据结构.md#order-委托对象) | 委托  
...
---|---|---  
context | [context](变量约定.md#context-上下文对象) | 上下文  
execrpt | [execrpt](数据结构.md#execrpt-回报对象) | 回报  
...
---|---|---  
context | [context](变量约定.md#context-上下文对象) | 上下文  
account | [account](数据结构.md#account-账户对象), 包含 account\_id\(账户 id\), account\_name\(账户名\),status\([账户状态](枚举常量.md#AccountStatus交易账户状态)\) | 交易账户状态对象，仅响应 已连接，已登录，已断开 和 错误 事件。  
