...
类型 | 说明  
---|---  
dict | [Cash 资金对象](数据结构.md#cash-资金对象)  
...
类型 | 说明  
---|---  
list\[position\] | [Position 持仓对象](数据结构.md#position-持仓对象)列表  
...
类型 | 说明  
---|---  
dict\[cash\] | [Cash 资金对象](数据结构.md#cash-资金对象)列表  
...
---|---|---  
symbol | str | 标的代码  
side | int | 持仓方向，取值参考[PositionSide 持仓方向](枚举常量.md#positioneffect开平仓类型)  
  
**返回值：**

类型 | 说明  
---|---  
dict\[position\] | [Position 持仓对象](数据结构.md#position-持仓对象)列表  
