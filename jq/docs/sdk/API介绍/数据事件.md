...
参数名 | 类型 | 说明  
---|---|---  
context | [context 对象](变量约定.md#context-上下文对象) | 上下文  
tick | [tick 对象](数据结构.md#tick-tick-对象) | 当前被推送的 tick  
...
参数名 | 类型 | 说明  
---|---|---  
context | [context 对象](变量约定.md#context-上下文对象) | 上下文对象  
bars | list\([bar](数据结构.md#Bar-Bar对象)\) | 当前被推送的 bar 列表  
...
---|---|---  
context | [context 对象](变量约定.md#context-上下文对象) | 上下文对象  
transaction | [L2Transaction 对象](API介绍/数据事件.md#on-l2transaction-逐笔成交事件) | 收到的逐笔成交行情  
...
---|---|---  
context | [context 对象](变量约定.md#context-上下文对象) | 上下文对象  
l2order | [L2Order 对象](数据结构.md#l2order-level2-逐笔委托) | 收到的逐笔委托行情  
